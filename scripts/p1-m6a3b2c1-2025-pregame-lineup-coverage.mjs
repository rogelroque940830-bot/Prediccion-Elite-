...
const EXPECTED_LINEUP_SOURCE_VERSION = "statsapi.mlb.com-v1.1-timecode-pregame-lineup.v4";
...
if (lineup.sourceVersion !== EXPECTED_LINEUP_SOURCE_VERSION) {
  throw new Error(`P1_M6A3B2C1_SOURCE_VERSION_MISMATCH:${lineup.sourceVersion}`);
}
...
const sourceIntegrity = {
  schemaVersion: "courtedge-p1-m6a3b2c1-2025-source-integrity.v4",
  generatedAt,
  frozenB1: {
...
const manifest = {
  schemaVersion: "courtedge-p1-m6a3b2c1-2025-lineup-coverage-manifest.v4",
  generatedAt,
  source: {
