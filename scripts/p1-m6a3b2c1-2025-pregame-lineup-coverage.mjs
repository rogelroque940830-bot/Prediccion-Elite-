...
const EXPECTED_LINEUP_SOURCE_VERSION = "statsapi.mlb.com-v1.1-timecode-pregame-lineup.v3";
...
const sourceIntegrity = {
  schemaVersion: "courtedge-p1-m6a3b2c1-2025-source-integrity.v3",
  generatedAt,
  frozenB1: {
...
const manifest = {
  schemaVersion: "courtedge-p1-m6a3b2c1-2025-lineup-coverage-manifest.v3",
  generatedAt,
  source: {
