...
def main():
    ...
    report = {
        ...
        "marketBoundary": {"providerMarketKey": "batter_home_runs", "repositoryRegistryFamily": "BATTER_PROP", "repositoryQuoteShape": "PLAYER_OVER_UNDER", "researchTargetEvent": "HOME_RUNS_GREATER_THAN_ZERO", "researchBinaryTargetMatchesProviderQuoteShape": False, "hardRockEvidenceSourceId": "HARD_ROCK_MLB_GUIDE_20260807", "historicalBatterHomeRunPricesUsed": False, "positiveEvEstablished": False, "hardRockFloridaPerEventAvailabilityEstablished": False, "priceCaptureAuthorized": False, "productionPromotionAuthorized": False},
