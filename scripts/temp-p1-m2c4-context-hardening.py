...
# The request helper already proves exact game/date/market/quote currentness. Avoid
# carrying a second UI-only currentness computation and a large duplicate status panel.
replace_once(
...
''',
    '''  type MlbManualQuoteCapture,
''',
    "remove redundant currentness import",
)
...
''',
    "",
    "remove redundant currentness memo",
)
...
''',
    '''        <div className="flex flex-wrap items-center gap-2" data-testid="p1-m2c4-manual-hardrock-capture">
          <Button
            type="button"
            size="sm"
            variant="outline"
